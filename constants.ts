...
const DEFAULT_CHAR_IMG = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII="; 
...
export const FACTIONS: Faction[] = [
    ...
    characters: [
      {
        ...
        outfit: "타이트한 블랙 레이스 드레스, 흰색 털 코트", appearance: "밝은 갈색 머리, 녹안, 업두 헤어, 육감적 몸매",
      ...
      },
      {
        ...
        outfit: "안경, 베이지색 코트, 갈색 치마, 흰 셔츠, 갈색 스카프 타이", appearance: "밝은 갈색 머리, 단발, 녹안, 보통 키, 차가운 인상",
    ...
    characters: [
      {
        ...
        outfit: "B.A.D 정복 (검은 정장, 코트)", appearance: "어두운 갈색 포마드 헤어, 금안, 탄탄한 근육, 무뚝뚝한 얼굴",
        backstory: "동양계.", 
      ...
      },
      {
        ...
        outfit: "B.A.D 정복", appearance: "은발 포니테일, 회색 눈, 보통 키, 마른 체형, 장난스런 얼굴",
        backstory: "백인.", 
    ...
    characters: [
      {
        ...
        outfit: "빨간 가죽 코트, 검은 셔츠/바지", appearance: "곱슬 짧은 머리, 언더컷, 시가, 어두운 피부, 근육질",
      ...
      },
      {
        ...
        outfit: "빨간 가죽 코트, 검은 셔츠/바지", appearance: "갈색 땋은 머리, 네이비 눈, 흰 피부, 주근깨, 큰 키",
        backstory: "이탈리아계.", 
      ...
      },
      {
        ...
        outfit: "빨간 가죽 코트, 검은 셔츠/바지", appearance: "검은 드레드락 헤어, 호박색 눈, 큰 키, 마른 몸",
    ...
    characters: [
      {
        ...
        outfit: "갈색 코트, 검은 셔츠/바지, 갈색 타이", appearance: "은발 짧은 헤어, 언더컷, 갈색 눈, 큰 키, 잘생김",
      ...
      },
      {
        ...
        outfit: "P.R.M 복장", appearance: "검은 스트레이트 헤어, 블런트뱅, 갈색 눈, 하얀 피부, 온화한 얼굴",
      ...
      },
      {
        ...
        outfit: "P.R.M 복장", appearance: "검은색 매우 곱슬머리, 묶음 머리, 보통 키, 마른 체형",
        backstory: "흑인. 해방된 노예 출신.", 
        image: "https://itimg.kr/1987/11/aa/마사.png",
        largeImage: "https://itimg.kr/1987/11/aa/마사확대.png"
      }
    ]
  },
  {
    ...
    characters: [
      {
        ...
        outfit: "회색 정장(타이X)", appearance: "검은 헤어, 양갈래 땋은 머리, 짧은 앞머리, 어두운 피부",
    ...
    characters: [
      {
        ...
        outfit: "빨간 셔츠, 화려한 검은 코트/베스트", appearance: "흰 머리, 빨간 눈, 흰 피부(알비니즘), 마른 몸",
    ...
    characters: [
      {
        ...
        outfit: "더러운 흰 셔츠, 갈색 가죽바지, 멜빵", appearance: "덥수룩한 미디움 헤어, 거친 수염, 작은 동공, 거대 근육질",
  ...
  },
  {
    ...
    slogan: "\"지옥을 홀로 걷는 자들.\"",
    logo: "https://itimg.kr/1987/11/aa/무소속.jpg", // Updated Image
    description: [
    ...
    characters: [
      {
        ...
        outfit: "갈색 체크무늬 낡은 정장", appearance: "금발, 벽안, 피곤한 인상, 부스스한 머리, 마른 몸, 큰 키",
      ...
      },
      {
        ...
        outfit: "흰색 블라우스, 빨간 코르셋, 검은 코트, 검은 바지", appearance: "빨간 머리, 에메랄드 눈, 큰 키, 큰 가슴, 육감적 몸매",
      ...
      },
      {
        ...
        outfit: "검은 바지, 흰 셔츠, 네이비 코트", appearance: "검은색 숏컷, 회색 눈, 마른 체형, 보통 키",
      ...
      },
      {
        ...
        outfit: "노란 체크 셔츠, 갈색 바지, 갈색 스카프", appearance: "오렌지 헤어, 곱슬머리, 로우포니테일, 호박색 눈, 작은 키, 귀여운 얼굴",
      ...
      },
      {
        ...
        outfit: "크림색 코트, 베이지색 바지, 흰 셔츠, 금색 스카프 타이", appearance: "금발, 벽안, 롱웨이브 헤어, 육감적 몸매, 큰 가슴",
